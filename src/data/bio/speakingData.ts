...
export const latestSpeaks = [
  ...
  ["Founder Platform", "Startup ecosystems, business growth and public conversations.", `${bio}IMG_9721.JPG.jpeg`],
  ["International Forum", "Global collaboration, founders and institutional leadership.", `${bio}KIVU9665.JPG.jpeg`],
  ["Recognition Platform", "Awards, business communities and innovation visibility.", `${bio}SEFH1150.JPG.jpeg`],
