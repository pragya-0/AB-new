export const identityCards = [
  ...
  ["Public Speaker", "Speaking across business forums, institutions, summits, television and global platforms."],
  ["TEDx Speaker", "Sharing entrepreneurship, technology and innovation stories with public audiences."],
  ...
  ["Game Programmer", "Associated with game development, simulation, character worlds and interactive media."],
  ["VR Specialist", "Working across VR, AR, XR and immersive technology experiences."],
