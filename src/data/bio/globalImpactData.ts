...
export const globalImpact = [
  ...
  ["Global Diplomacy", "Connecting business communities, delegations and innovation leaders across international platforms.", `${bio}world-leader-summit-group.jpeg`],
  ["International Partnerships", "Building bridges between entrepreneurs, investors, institutions and cross-border business networks.", `${bio}world-leader-summit-meeting.jpeg`],
