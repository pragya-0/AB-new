...
export const books = [
  ...
  ["The Power of Generic AI", "AI, creativity and future technology.", `${booksPath}power of Ai.png`],
  ["The VR Sega", "Virtual reality and immersive storytelling.", `${booksPath}Vr.png`],
  ["The Legend Comes Alive", "Fantasy, mythology and character universe.", `${booksPath}Alive.png`],
