...
export const gameWorlds = [
  ...
  ["Character Worlds", "Heroes, villains, mythology-inspired characters and visual storytelling.", `${gamePath}comics-img6.jpg`],
  ["Legend Comes Alive", "Fantasy, mythology and graphic-novel style storytelling universe.", `${gamePath}comics-img4.jpg`],
