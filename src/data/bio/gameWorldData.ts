...
export const gameWorlds = [
  ...
  ["Character Worlds", "Heroes, villains, epic-inspired characters and visual storytelling.", `${gamePath}comics-img6.jpg`],
  ["Legend Comes Alive", "Fantasy, epic storytelling and graphic-novel style storytelling universe.", `${gamePath}comics-img4.jpg`],
  ["VR Gaming", "Virtual reality, immersive worlds and interactive game experiences.", `${gamePath}WhatsApp Image 2026-06-16 at 19.23.54.jpeg`],
