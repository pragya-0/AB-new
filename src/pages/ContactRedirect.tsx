...
export default function ContactRedirect() {
  ...
  return (
    <>
      <MetaTags
        title="Contact Arijit Bhattacharyya | Speaking, Mentoring, Investment & Partnerships"
        description="Contact Arijit Bhattacharyya for speaking invitations, leadership forums, startup mentoring, technology advisory, investment ecosystem conversations, media interactions, institutional collaborations and global partnerships."
      />
