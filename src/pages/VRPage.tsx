...
import SmartCityDomains from "../components/vr/07-SmartCityDomains";
  ...
  return (
    <main className="min-h-screen bg-[#03070d] font-sans text-white">
      <MetaTags
        ...
        description="Explore Arijit Bhattacharyya's work in Virtual Reality India, Virtual Reality Kolkata, Immersive Technology, Mixed Reality, immersive technology, VRML, digital humans, game development, healthcare simulation, defence simulation, banking simulation, recruitment and training, ship and oil-rig simulation, smart cities, robotics, digital twins, Microsoft technologies, enterprise technology experience, Unity, Unreal, OpenGL, CUDA and immersive technology since 1998. Virtual Reality game developer in Kolkata, India."
