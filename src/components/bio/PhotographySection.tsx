    ...
    >
      <div className={`relative ${imageHeight} overflow-hidden`}>
        ...
        <div className="absolute bottom-6 left-6 right-6">
          <h3 className="text-[30px] font-extrabold leading-[0.95] tracking-[-0.055em] text-white md:text-[42px]">
            {title}
          </h3>
          {text && (
      ...
      <div className="space-y-6">
        ...
        >
          <div className="mb-7">
            ...
            <h3 className="max-w-[1000px] text-[34px] font-extrabold leading-[0.92] tracking-[-0.06em] text-white md:text-[52px]">
